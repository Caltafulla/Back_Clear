import {
  Submission,
  CreateSubmissionWithUserRequest,
  SubmissionStatus,
  ProgrammingLanguage,
...
export interface ISubmissionRepository {
  ...
  // 👇 antes recibía CreateSubmissionRequest
  create(submissionData: CreateSubmissionWithUserRequest): Promise<Submission>;
  ...
  findBestSubmissionByUserAndChallenge(
    userId: string,
    challengeId: string,
